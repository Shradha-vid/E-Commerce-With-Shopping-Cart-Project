...
$sql = "SELECT * FROM mens_coll";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table id='jquery-datatable'>";
    echo "<thead><tr><th>Product Number</th><th>Name of the Outfit</th><th>Material Type</th><th>Description</th><th>Delete</th><th>Update</th></tr></thead><tbody>";
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>". $row["Product_No"]. "</td><td>". $row["outfit_name"]. "</td><td>" . $row["material_type"] . "</td><td>".  $row["describe_cost"];
