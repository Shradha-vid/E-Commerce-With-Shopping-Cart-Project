...
<form action="prod_size_sub.php" method="post" >
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="forms-sample">
                      ...
                      <div class="form-group" >
                        <label for="outfit">Enter the size_id: </label>
                        <input type="text" class="form-control" name="size_id" placeholder="Enter the category: ">
                      </div>
