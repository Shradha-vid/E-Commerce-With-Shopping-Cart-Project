...
if(isset($_POST['outfit'], $_POST['material'], $_POST['Desc'], $_POST['mrp'], $_POST['salp'], $_FILES["photo"])) {
    ...
    if (move_uploaded_file($filetmp, $filepath)) {
        ...
        $sql = "INSERT INTO kids_coll (outfit_name, material_type, describe_cost, photo, mrp, salp) VALUES ('$outfit','$material','$Desc','$filepath','$mrp','$salp')";
    ...
    echo '<script type="text/javascript">
        window.location.href = "kidsdisplay.php";
    </script>';
